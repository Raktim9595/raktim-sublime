...
$url        = 'https://download.sublimetext.com/Sublime%20Text%20Build%203211%20Setup.exe' # download url, HTTPS preferred
$url64      = 'https://download.sublimetext.com/Sublime%20Text%20Build%203211%20x64%20Setup.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'raktmsublimettext1*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum      = '72350BE01792FEABF1C13F66DCA8FE57C65EE16DE90A2345D135A38C8A8A670B'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = '17A659D3B09299481C7DF52DAF5FE3B8930A157B6139EBE5A1D8BDC0C2F3D7F4'
